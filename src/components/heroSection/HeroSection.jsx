  ...
  return (
    <div className='w-full h-[80vh] relative'>
        ...
        <div className='absolute top-[30%] left-[10%]'>
            ...
            <button className='bg-orange-500 flex justify-center items-center gap-2 p-[10px] rounded-full my-[30px] font-semibold text-white hover:bg-orange-400 animate-bounce'>Explore Now <FaArrowRight /></button>
        </div>
    </div>
  )
}
